    ...
    >
      ...
      >
        ...
        <ProjectSection variants={itemVariants}>
          <h3>프로젝트 목표</h3>
          <p>기존에 가지고 있던 리눅스 및 서버 관련 지식을 실제 환경에 적용하고 확장하기 위해 이 프로젝트를 선택했습니다. CLI 환경에서의 서버 구축(웹/개발 서버) 및 호스팅 전 과정을 직접 경험하며 운영 역량을 심화시키는 것을 목표로 삼았습니다.</p>
        </ProjectSection>
        <ProjectSection variants={itemVariants}>
          <h3>주요 기능</h3>
          <ul>
            ...
            <li>SSH를 통한 안전한 원격 개발 지원</li>
            <li>Git을 이용한 소스 코드 형상 관리</li>
            <li>MariaDB를 이용한 관계형 데이터베이스 관리</li>
            <li>Caddy를 이용한 웹 서버 구축 및 리버스 프록시 설정</li>
          </ul>
        </ProjectSection>
        ...
        <ProjectSection variants={itemVariants}>
          ...
          <TechStackList>
            ...
            <li><strong>데이터베이스:</strong> MariaDB - 관계형 데이터베이스 </li>
        ...
        <ProjectSection variants={itemVariants}>
          ...
          <p>
            <strong>결과:</strong>
            <br />
            Proxmox 가상화 환경 위에 Debian 기반의 안정적인 개인 개발 서버 구축을 완료했습니다. 이를 통해 Node.js, Java 등 필요한 개발 스택을 언제든 구성하고 테스트할 수 있는 환경을 확보했으며, UFW와 Fail2ban을 이용한 기본적인 서버 보안 체계를 갖추었습니다.
          </p>
          <LearnedPointsList style={{ marginTop: '2rem' }}> 
            ...
            <li>
              ...
              방화벽 규칙 설정(UFW)과 비정상 로그인 시도 차단(Fail2ban)을 직접 구성해보며, 외부로부터 서버를 보호하기 위한 기본적인 보안 조치의 중요성과 실제 적용 방법을 학습했습니다.
            </li>
            <li>
